...
metadata {
	...
	tiles {
		standardTile("valve", "device.valve", width: 2, height: 2) {
			state("closed", label:'${name}', action:"valve.open", icon:"st.valves.water.open", backgroundColor:"#00A0DC")
			state("open", label:'${name}', action:"valve.close", icon:"st.valves.water.closed", backgroundColor:"#e86d13", )
			state("opening", label:'${name}', action:"valve.open", icon:"st.valves.water.open", backgroundColor:"#e86d13")
			state("closing", label:'${name}', action:"valve.close", icon:"st.valves.water.closed", backgroundColor:"#00A0DC")
