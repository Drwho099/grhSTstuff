 ...
 *  2017-07-21: GRH - trivial GUI tweaks, mainly for consistency with other HEMv1 DTH 
 *  2017-07-25: GRH - More functional changes, input interval times & tweaked report group1
 *  2017-07-27: GRH - Forked new proto copy for ongoing experimentation
 * 				- 
 */
metadata {
	// Automatically generated. Make future change here.
	definition (
		name: 		"Aeon HEMv2+ Prototype", 
...
// v1		fingerprint deviceId: "0x2101", inClusters: " 0x70,0x31,0x72,0x86,0x32,0x80,0x85,0x60"
    ...
    // GRH - Add same ICON as HEM v1 handler I use...
 ...
 //   GRH - Get rid of useless amps row
 // Amps row
...
// HEM Version Configuration only needs to be done here - comments to choose what gets displayed
		...
		main (["powerDisp","energyTwo",         // GRH - swapped order of powerDisp and energyDisp
			// "ampsDisp","voltsDisp",				// Comment out this one for HEMv1, GRH also commented out as testing
			"energyDisp"
			])
		details([
			"voltsOne","voltsDisp","voltsTwo",		// Moved to top (its more like a header) 
            "energyOne","energyDisp","energyTwo",
			"powerOne","powerDisp","powerTwo",
  			"ampsOne","ampsDisp","ampsTwo",			// GRH Edit remove AMPS row // Comment out these two lines for HEMv1
    ...
    preferences {
    	...
    	input "kWhDelay", "number", title: "kWh report seconds (120)", /* description: "120", */ defaultValue: 120   // GRH
    	input "detailDelay", "number", title: "Watts report seconds (30)", /* description: "30", */ defaultValue: 30
    }
}
...
def configure() {
	...
	def cmd = delayBetween([
		zwave.configurationV1.configurationSet(parameterNumber: 2, size: 1, scaledConfigurationValue: 1).format(),			// Enable Negative Power Values - GRH
...
//		zwave.configurationV1.configurationSet(parameterNumber: 100, size: 1, scaledConfigurationValue: 0).format(),		// reset to defaults
		zwave.configurationV1.configurationSet(parameterNumber: 101, size: 4, scaledConfigurationValue: 6145).format(),   	// GRH (was 6149: All L1/L2 kWh, total Volts & kWh)
		zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: kDelay).format(), 		// Every 60 seconds  // GRH Change to kDelay
		...
		zwave.configurationV1.configurationSet(parameterNumber: 112, size: 4, scaledConfigurationValue: 900).format(), 		// every 30 seconds  // GRH Change to 15mins
		...
		zwave.configurationV1.configurationSet(parameterNumber: 113, size: 4, scaledConfigurationValue: dDelay).format() 		// every 6 seconds   // GRH Change to dDelay
	], 2000)
	log.debug cmd
