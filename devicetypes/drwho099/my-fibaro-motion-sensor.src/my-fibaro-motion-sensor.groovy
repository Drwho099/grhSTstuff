 ...
 * 3.   20170812        GRH swapped motion and temp order on main tile assertion
 */
 ...
 */
 metadata {
	definition (name: "My Fibaro Motion Sensor", namespace: "Drwho099", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.motion") {
