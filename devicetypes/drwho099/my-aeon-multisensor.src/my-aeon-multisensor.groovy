 ...
 *
 *  08-12-17 : GRH changed order of main tile calls
 *  
 */
metadata {
	definition (name: "My Aeon Multisensor", namespace: "Drwho099", author: "SmartThings") {
	...
	tiles(scale: 2) {
		...
		main(["temperature", "motion", "humidity", "illuminance"])		// GRH - swapped motion/temp order
