 ...
 *.     09-27-2020 : GRH - Mods to support Gen2 (negative numbers) only 
 */
metadata {
	definition (name: "My Aeon Gen 2 Home Energy Meter", namespace: "Drwho099", author: "jsconstantelos", mnmn: "SmartThingsCommunity", vid: "373af1eb-cdc4-3246-b99a-1bba01547b68") {
...
// GRH: remove negative value check    	if (value > 0)   {                
